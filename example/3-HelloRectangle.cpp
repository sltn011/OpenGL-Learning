...
namespace Shaders {
    char const *vertexShaderSource = 
        ...
        "   vertexColor = vec4(0.75f, 0.25f, 0.25f, 1.0f);\n" // will be sent to fragmentShader
        "}"
    ;
...
(
    ...
    // Create window
    GLFWwindow *window = glfwCreateWindow(Screen::width, Screen::height, "Hello, Rectangle", nullptr, nullptr);
    if (!window) {
